...
public class TransactionRepositoryJdbcImplTest {
	...
	private void setUpPerTest() {
		...
		transactionRepositoryImplUnderTest = RepositoryFactory.getTransactionRepository(propertiesFilePathTest);

		utilisateurRepositoryImplUnderTest = RepositoryFactory.getUtilisateurRepository(propertiesFilePathTest);
	}
